...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter) {
        ...
        lblstate.setBounds(30,190,100,20);
        add(lblstate);
        
         tfstate = new JTextField();
        tfstate.setBounds(230,190,200,20);
        add(tfstate);
        
        JLabel lblcity = new JLabel("City");
        lblcity.setBounds(30,230,100,20);
        add(lblcity);
        
         tfcity = new JTextField();
        tfcity.setBounds(230,230,200,20);
        add(tfcity);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == update) {
            ...
            try {
                Conn c = new Conn();
                c.s.executeUpdate("update customer set address='"+address+"', state ='"+state+"', city='"+city+"', email = '"+email+"', phone_no='"+phone+"' where meter_no='"+meter+"'");
