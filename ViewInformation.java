...
public class ViewInformation extends JFrame implements ActionListener{
    ...
    ViewInformation(String meter) {
        ...
        lblstate.setBounds(70,260,100,20);
        add(lblstate);
        
        JLabel state = new JLabel("");
        state.setBounds(250,260,100,20);
        add(state);
        
        JLabel lblcity = new JLabel("City");
        lblcity.setBounds(500,80,100,20);
        add(lblcity);
        
        JLabel city = new JLabel("");
        city.setBounds(650,80,100,20);
        add(city);
        ...
        image.setBounds(20,350,600,230);
        add(image);
